...
RSpec.describe 'Categories #Show page', type: :feature do
  before(:each) do
    ...
    @cash_tracker1 = CashTracker.create(name: 'my cash tracker 1st', amount: 1003.20, categories_id: @category.id, user_id: @user.id)
    @cash_tracker2 = CashTracker.create(name: 'my cash tracker 2nd', amount: 100.20, categories_id: @category.id, user_id: @user.id)
